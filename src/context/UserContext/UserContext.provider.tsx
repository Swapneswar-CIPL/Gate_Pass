...
const initialData = {
    updateBasicDetails: illegalStateFunction,
    updateEducationDetails: illegalStateFunction,
...
function UserContextProvider({ children }: UserContextProviderProps) {
    const auth = useAuth();
    const updateBasicDetails = (basicDetailsObj: BasicDetails) => {
    ...
    const updateEducationDetails = (
        EducationDetailsArr: EducationDetails[],
    ) => {
        const response = axios.post(
    ...
    const createWorkExperienceDetails = (
        WorkExperienceDetailsArr: WorkExperienceDetails[],
    ) => {
        const response = axios.post(
            '/api/work/creatework',
            WorkExperienceDetailsArr,
        );
        return response;
    };
