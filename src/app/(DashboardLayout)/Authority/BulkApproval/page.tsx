...
const ProductPerformance = () => {
    ...
    const getData = async () => {
      try {
        const res = await axios.get(
          `${process.env.NEXT_PUBLIC_BACKEND_BASE_URL}/api/authorities/getAll/false`
        );
  ...
  return (
    <PageContainer title="Bulk Approval" description="Bulk Approval">
      <DashboardCard title="Bulk Approval">
        <>
          <DataGrid
            checkboxSelection
