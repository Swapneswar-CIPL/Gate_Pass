...
const Dashboard = () => {
  ...
  const handleSubmit = async () => {
    const formData = { mobile_num, formattedNames, unique_id, unique_id_type, gender, reporting_officer, building_room_num, address, material, message_and_purpose, picture };
                ...
                <>
                  ...
                  <Box sx={{ display: { xs: "block", sm: "flex", md: "flex" } }}>
                    <Stack sx={{ width: { xs: "100%", sm: "50%", }, mr: 2 }}>
                      ...
                      <CustomTextField2 value={messageConveyedBy} width="80%" variant="outlined" fullWidth name={messageConveyedBy}
                        onChange={(event: any) => setMessageConveyedBy(event.target.value)}
                      />
                    ...
                    <Stack sx={{ width: { xs: "100%", sm: "50%", }, }}>
                      ...
                      <AddressTextArea id="location" variant="outlined" fullWidth name="location" value={message_and_purpose} inputProps={{ maxLength: 300 }} onChange={(e: any) => {
          ...
          <Box sx={{ width: "600px", padding: "10px", }}>
            <Grid container xs={12} sx={{}}>
              ...
              <Grid xs={4} sx={{ paddingLeft: '7px' }} >
                <Box>
                  {/* <Typography fontWeight="bold" >Daily Visitor Pass</Typography> */}
                  {/* <Typography sx={{ fontSize: "10px", marginTop: '2px', display: 'flex', alignItems: 'center', height: '13px' }} fontWeight="bold" >
                    <span style={{ marginRight: "3px", display: 'flex', alignItems: 'center', }}>
                      <img src={icon3.src} alt="Icon 06" height="12px" />&nbsp;  Reg. Time: 
                      {dayjs(passData.createdAt).format(" HH:mm:ss")}
                    </span>
                  </Typography> */}
                </Box>
