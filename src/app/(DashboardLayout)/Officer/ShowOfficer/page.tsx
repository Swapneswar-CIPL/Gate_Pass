...
const ProductPerformance = () => {
            ...
            <Grid container spacing={2}>
              <Grid item xs={12}>
                ...
                <BoxWrapper>
                  ...
                  <Typography> {selectedProduct.officer_name}</Typography>
                </BoxWrapper>
                <BoxWrapper>
                  <Typography fontWeight={600}>Designation:</Typography>
                  <Typography> {selectedProduct.designation}</Typography>
                </BoxWrapper>
                <BoxWrapper>
                  <Typography fontWeight={600}>Room No:</Typography>
                  <Typography> {selectedProduct.building_room_num}</Typography>
                </BoxWrapper>
                <BoxWrapper>
  ...
  useEffect(() => {
    async function fetchOfficers() {
      const passes = await getAllOfficers();
  ...
  const columns: GridColDef[] = [
    ...
    { field: "officer_name", headerName: "Name", width: 190 },
  ...
  return (
    <PageContainer title="Show Officer" description="List of all the officer">
